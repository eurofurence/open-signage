...
<template>
  <div class="flex absolute z-30 h-[100vh] w-[100vw] justify-items-center overflow-hidden">
          ...
          >
            ...
            <div class="relative flex flex-row flex-nowrap">
              <div v-if="item.delay" class="flex flex-row items-baseline text-4xl">
                <div v-if="item.delay < 15" class="flex text-left" style="color: #ffa500 !important">
                  Slightly Delayed
                </div>
                <div v-else class="flex text-left" style="color: #f05d65 !important">Delayed: {{ item.delay }}min</div>
              </div>
    ...
    <div
      ...
      style="z-index: 9999"
    >
      <img src="../Assets/images/foreground.png" class="background_foreground" />
    </div>
  </div>
</template>
